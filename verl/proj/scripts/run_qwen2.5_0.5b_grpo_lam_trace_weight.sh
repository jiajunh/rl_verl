...
PROJECT_NAME='Qwen2.5-0.5B-Instruct_math_grpo'
...
VAL_GEN_SAVE_PATH=/n/netscratch/kdbrantley_lab/Lab/jiajunh/test_verl/verl/proj/val_generation/Qwen2.5-0.5B-Instruct/${DATA}/${EXPERIMENT_NAME}
