...
EXPERIMENT_NAME='grpo_lam_trace_weight_recent_lam_0.99_sft'

DATA="math"
# DATA="gsm8k"

# MODEL_PATH=Qwen/Qwen2.5-1.5B-Instruct
MODEL_PATH=/n/netscratch/kdbrantley_lab/Lab/jiajunh/test_verl/models/qwen_2.5_1.5b/global_step_58/huggingface
