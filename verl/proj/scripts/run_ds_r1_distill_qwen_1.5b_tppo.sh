...
EXPERIMENT_NAME='tppo_window_1024_no_removing_sample_4'

MODEL_PATH=deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B

VAL_GEN_SAVE_PATH=/n/netscratch/kdbrantley_lab/Lab/jiajunh/test_verl/verl/proj/val_generation/DeepSeek-R1-Distill-Qwen-1.5B/math/${EXPERIMENT_NAME}
...
python -m verl.trainer.main_tppo \
    ...
    algorithm.tppo.window_length=1024 \
    algorithm.tppo.k=4 \
    "$@"
