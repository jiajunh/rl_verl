...
if __name__ == "__main__":
    ...
    if not args.split:
        ...
        split_dataset = full_dataset.train_test_split(test_size=0.3, seed=42)
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            ...
            data = {
                ...
                "ability": "math",
                "reward_model": {"style": example["reward_model"]["style"], "ground_truth": example["reward_model"]["ground_truth"]},
                "extra_info": {
                    "split": split,
                    "index": idx,
                },
